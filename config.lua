...
-- رابط Discord webhook لتسجيل كل عملية تصنيع ناجحة (اسم اللاعب، العنصر، الكمية، الوقت)
-- اتركه فاضي '' لو ما تبي لوق ديسكورد
-- كيف تسويه: إعدادات قناة الديسكورد > تعديل القناة > التكاملات > Webhooks > إنشاء ويبهوك > نسخ الرابط
